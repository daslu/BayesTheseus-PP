...
#https://github.com/fehiepsi/pyro/blob/1b82e98e095ed42b510b660c6609f269b25d3179/pyro/infer/static_svi.py
...
class StaticSVI(SVI):
    ...
    def _check_optim(self, optim):
        if not isinstance(optim, torch.optim.PyroOptim):
            raise ValueError("Optimizer should be an instance of torch.optim.PyroOptim class.")
